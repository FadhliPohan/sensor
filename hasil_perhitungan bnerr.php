...
function get_ket($suhu,$nilai){
	$sql=mysqli_query("SELECT * FROM `tb_rule` WHERE is_golongan='$suhu' and nilai='".$nilai."' GROUP BY is_sub_golongan,keterangan_nilai");
...
function nilai_parameter_a($is_sub_golongan,$keterangan,$suhu,$keterangan_nilai,$golongan,$ket_nilai){
	$sql=mysqli_query("SELECT * FROM `tb_rule` WHERE is_golongan='$golongan' and nilai='".$suhu."' and keterangan_nilai='".$keterangan_nilai."' GROUP BY is_sub_golongan,keterangan_nilai");
					while($row=mysqli_fetch_array($sql)){
		...
		<div class="panel panel-default">
				...
				<div class="container">
				  ...
				  <div class="tab-content">
					...
					<?php 
						$judul = mysqli_query("SELECT * FROM tb_hasil WHERE keterangan = 'Very Cold' OR keterangan = 'Cold' OR keterangan = 'Normal' AND golongan = '0' OR keterangan = 'Hot' OR keterangan = 'Very Hot'")or die(mysqli_error());	
					 ?>
					
					<ul class="list-group">						
					 	<?php while ($data = mysqli_fetch_array($judul)) { ?>
						...
						<table>
							<tr>
							<?php
							$data0=mysqli_query("select *  from tb_hasil ");
