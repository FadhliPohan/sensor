...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	data: [{
		...
		$sql=mysqli_query($konek, "select * from node_1 where status='1' ");
	...
	},
	{
		...
		$sql=mysqli_query($konek, "select * from node_1 where status='2'  ");
		while($row=mysqli_fetch_array($sql)){
		?>
...
var chart = new CanvasJS.Chart("chartContainer2", {
	...
	data: [{
		...
		dataPoints: [
		<?php
		$sql=mysql_query($konek, "select * from node_1 where status='1' ");
	...
	},
	{
		...
		dataPoints: [
		<?php
		$sql=mysql_query($konek,"select * from node_1 where status='2'  ");
		while($row=mysql_fetch_array($sql)){
		?>
