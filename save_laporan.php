		...
		<h5 style="text-align:center">Report  <br /> MONTH '.$_GET['bulan'].' YEAR '.$_GET['tahun'].'</h5>
			<table class=""  style="border-collapse:collapse;width:100%;" width="800px" border=1>
						...
						';
							...
							$nomor=0;
							$sql = "SELECT * from tbl_hasil_menit where MONTH(tanggal)='".$_GET['bulan']."' AND YEAR(tanggal)='".$_GET['tahun']."'";
							$tampil22 = mysqli_query($konek, $sql);
							while ($data222 = mysqli_fetch_array($tampil22)) {
								$content .="
							<tr>
							<td>
									".$data222['tanggal']."
