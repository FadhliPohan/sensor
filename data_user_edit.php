...
<?php 
			if (isset($_POST['simpan'])) {
				...
				if($password == ""){
$sql = "UPDATE tbl_user SET email='$email',status='$status' where id_user='".$_POST['id_user']."'";
				
				}else{
				$sql = "UPDATE tbl_user SET email='$email',password='$password',status='$status' where id_user='".$_POST['id_user']."'";
